...
//Trace
 ...
 #define TRACE_GLOBAL(...) rprintf(DBG,__VA_ARGS__)
// #define TRACE_GLOBAL(...)  //
...
#define SET_LED_PA1 AT91F_PIO_SetOutput(AT91C_BASE_PIOA,AT91C_PIO_PA1)
#define CLR_LED_PA1 AT91F_PIO_ClearOutput(AT91C_BASE_PIOA,AT91C_PIO_PA1)
